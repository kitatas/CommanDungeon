...
namespace OneButton.InGame.Installer
{
    public sealed class InGameInstaller : LifetimeScope
    {
        ...
        [SerializeField] private UserNameView userNameView = default;
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.RegisterEntryPoint<UserDataPresenter>();
            ...
            builder.RegisterInstance<UserNameView>(userNameView);
